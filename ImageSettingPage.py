...
class Ui_Form(QObject):
    def setupUi(self, Form):
        ...
        self.ImageResolutionText = QtWidgets.QLabel(Form)
        self.ImageResolutionText.setObjectName("ImageResolutionText")
        self.horizontalLayout_11.addWidget(self.ImageResolutionText)
    ...
    def retranslateUi(self, Form):
        ...
        self.ImageResolutionText.setText(_translate("Form", "Image resolution:"))
...
# Checks if Image setup file is present, if not creates it with the given parameters.
def FilePresentEnsured():
    if not exists(SetupFile.ImageSetupFilePath):
        ImageSettingWriteToFile(True, 0, 100, 100)


def ImageSettingWriteToFile(RadioButton, ComboBoxIndex, ImageWidth, ImageHeight):
...
class MyWindow(QtWidgets.QWidget, Ui_Form):
    ...
    # Updates the UI from the image setting file.
    ...
    def EnableButtons(self, Boolean):
        ...
        self.ImageResolutionText.setEnabled(Boolean)
